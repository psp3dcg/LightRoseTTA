...
export BLASTMAT="msa_feat/blast-2.2.26/data/"
DATADIR="msa_feat/psipred-master/data/"
echo $DATADIR
...
msa_feat/csblast-2.2.3/bin/csbuild -i $i_a3m -I a3m -D msa_feat/csblast-2.2.3/data/K4000.crf -o $ID.chk -O chk
csbuild="msa_feat/csblast-2.2.3/bin/csbuild -i $i_a3m -I a3m -D msa_feat/csblast-2.2.3/data/K4000.crf -o $ID.chk -O chk"
echo $csbuild
